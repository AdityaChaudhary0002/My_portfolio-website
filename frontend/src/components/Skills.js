    ...
    <section id="skills" className="min-h-screen flex items-center px-4 py-20">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Programming */}
          <motion.div
            className="bg-white dark:bg-[#0a0a0a] rounded-3xl overflow-hidden border border-gray-200/60 dark:border-white/10 transition-all duration-500 hover:border-gray-300 dark:hover:border-white/20 hover:shadow-2xl dark:hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.05)] p-6 text-center"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            whileHover={{ y: -4 }}
          ...
          >
            ...
            <div className="space-y-3 pl-4">
              ...
              <div className="flex items-start justify-start gap-3">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/supabase/supabase-original.svg" alt="Supabase" className="w-6 h-6 flex-shrink-0 object-contain" />
                <span className="text-gray-800 dark:text-gray-300">Supabase</span>
              </div>
              <div className="flex items-start justify-start gap-3">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/prisma/prisma-original.svg" alt="Prisma" className="w-6 h-6 flex-shrink-0 object-contain dark:invert" />
                <span className="text-gray-800 dark:text-gray-300">Prisma (ORM)</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-3 pl-4">
              ...
              <div className="flex items-start justify-start gap-3">
                <svg className="w-6 h-6 flex-shrink-0 text-gray-800 dark:text-gray-300" viewBox="0 0 24 24" fill="currentColor">
