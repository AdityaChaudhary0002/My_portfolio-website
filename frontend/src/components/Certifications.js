      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-white">React.js Development</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-white">Node.js Backend Development</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-white">MongoDB Database Design</h3>
            <p className="text-gray-400 mb-1">MongoDB University</p>
            <p className="text-gray-500 mb-3">2024</p>
            <div className="flex items-center justify-center gap-2">
              <svg className="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 24 24">
                <path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-white">Git & GitHub</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2 text-white">Web Development Fundamentals</h3>
